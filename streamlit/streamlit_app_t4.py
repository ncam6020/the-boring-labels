...
st.set_page_config(layout="centered", page_title="The Boring CSV Machine", page_icon="❄️")
...
if uploaded_classifier_file and uploaded_room_names_file:
    ...
    for original_name, i in room_names_df['Original Room Name'].unique():
        ...
        initial_suggestion.append(top_matches)
        ...
        'Top Suggestion': initial_suggestion[i]
    })
